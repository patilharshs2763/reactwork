    ...
    <>
      <Row className="container py-3">
        ...
        <Col xs={24} sm={24} md={16} lg={12} xl={12}>
          ...
          {/* <div className='devminds-audbtn'>
                        <Button className='devminds-audience' variant="contained" endIcon={<SendIcon />}>
                           <span className='devminds-textfind'>Find audience</span> 
                        </Button>
                    </div> */}
          <Commentbutton text="Find audience" endIcon={<SendIcon />} className="devmind-OnHoverBtn" />
        </Col>
        <Col xs={24} sm={24} md={4} lg={6} xl={6}></Col>
      </Row>
    </>
